...
export default function Register() {
  ...
  return (
    <div>
      <h1 className="text-white text-[50px] animate-fade-down animate-once animate-duration-[2000ms] md:text-[96px] font-primary text-center">
        MundoGamer
      </h1>
      <section className="flex justify-center animate-fade-up animate-once animate-duration-[2000ms]">
